...
const OrgApproveSeparation = () => {
  ...
  if (isApproveSeparation || (!normalAdminAccessGivenFun(Access) && Access))
          ...
          <div className="cs_edit_div">
            <div>
              ...
              >
                ...
                <div>
                  <h2 className="cs_edit_employee_head"> Approve Separation</h2>
                </div>
              </Link>
            </div>
            ...
            <div className="cs_edit_submit_cancel_div">
              <div>
                <button
                  ...
                  onClick={() => dispatch(approveExitDetailsAction(id))}
                >
                  Confirm Approve
                </button>
              </div>
...
export default OrgApproveSeparation;
