...
const PayrollUpdate = () => {
  ...
  const { singlepayroll, isDeleted, loading, appErr, serverErr } = payroll;
          ...
          <div className="cs_edit_div">
            <div>
              ...
              >
                ...
                <div>
                  <h2 className="cs_edit_employee_head"> Delete Payroll</h2>
                </div>
              </Link>
            </div>
            ...
            <div className="cs_edit_submit_cancel_div">
              <div>
                <button
                  ...
                  onClick={() => dispatch(deletepayrollAction(id))}
                >
                  Confirm Delete
                </button>
              </div>
