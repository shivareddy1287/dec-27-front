        ...
        return (
          <Box sx={{ m: 1, p: 2, postition: "relative" }}>
            <IconButton
              ...
              onClick={() =>
                navigate(`/self-service/exitdetails/view/${params.row.id}`)
              }
            >
              {" "}
              <VisibilityIcon />
            ...
            {params.row.Access && (
              <>
                <IconButton
                  ...
                  onClick={() =>
                    navigate(
                      `/self-service/exitdetails/update/${params.row.id}`
                    )
                  }
                >
                  {" "}
                ...
                <IconButton
                  ...
                  onClick={() =>
                    navigate(
                      `/self-service/exitdetails/delete/${params.row.id}`
                    )
                  }
                >
                  {" "}
                ...
                <IconButton
                  ...
                  onClick={() =>
                    navigate(
                      `/self-service/exitdetails/withdraw/${params.row.id}`
                    )
                  }
                >
                  W
